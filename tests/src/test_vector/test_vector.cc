...
TEST_CASE("Complex de/serialization") {
    ...
    SECTION("Vector of non-trivial elements") {
        ...
        struct non_trivial_b {
            std::array<std::vector<non_trivial_a>, 2> v0 = { { { non_trivial_a{} }, { non_trivial_a{} } } };
            std::array<std::vector<non_trivial_a>, 2> v1 = { { { non_trivial_a{} }, { non_trivial_a{} } } };

            non_trivial_a a0 = non_trivial_a{};
            non_trivial_a a1 = non_trivial_a{};
            non_trivial_a a2 = non_trivial_a{};
