...
TEST_CASE("Compile-time test MD5 hashes") {
    SECTION("Test 1") {
        ...
        COMPTIME_ASSERT_EQ(hash_128, teg::md5_digest(0x01252fe0, 0xa5e1ca37, 0x430b22ec, 0xba121134));
    ...
    SECTION("Test 2") {
        ...
        COMPTIME_ASSERT_EQ(hash_128, (teg::md5_digest{0x624c89bb, 0x6f2573d7, 0x624e1420, 0x9de8f492}));
    ...
    SECTION ("Test 3") {
        ...
        COMPTIME_ASSERT_EQ(hash_128, (teg::md5_digest{0xc9e04138, 0xe5f3abb6, 0x18a7a124, 0xc9a92ab2}));
    ...
    SECTION ("Test 4") {
        ...
        COMPTIME_ASSERT_EQ(hash_128, (teg::md5_digest{0xd3f8915e, 0xd0982084, 0x1add8cdb, 0x39387700}));
